...
public class Robot {
    ...
    static final int HEAD_X = 7;
    static final int HEAD_Y = 0;
    static final int CORE_X = 5;
    ...
    static final int LEFT_LEG_Y = 29;
    static final int RIGHT_LEG_Y = 29;
    static final int LEFT_TIRE_X = 0;
    static final int RIGHT_TIRE_X = 18;
    static final int LEFT_TIRE_Y = 49;
    static final int RIGHT_TIRE_Y = 49;
    ...
    public void paint(Graphics g, ImageObserver observer) {
        ...
        g2d.drawImage(leg, (int)x+LEFT_LEG_X, (int)y+LEFT_LEG_Y, observer);
        g2d.drawImage(leg, (int)x+RIGHT_LEG_X, (int)y+RIGHT_LEG_Y, observer);
        g2d.drawImage(base, (int)x+BASE_X, (int)y+BASE_Y+tension, observer);
        g2d.drawImage(tire, (int)x+LEFT_TIRE_X, (int)y+LEFT_TIRE_Y, observer);
        g2d.drawImage(tire, (int)x+RIGHT_TIRE_X, (int)y+RIGHT_TIRE_Y, observer);
